...
class Lodgement(models.Model):
    ...
    type_lodgement = models.ForeignKey(
        TypeLodgement, on_delete=models.CASCADE, related_name="lodgements"
    )
    quartier = models.ForeignKey(
        Quartier, on_delete=models.CASCADE, related_name="lodgements"
    )
...
class Location(models.Model):
    ...
    lodgement = models.ForeignKey(
        Lodgement, on_delete=models.CASCADE, related_name="locations_lodg"
    )
    locator = models.ForeignKey(
        Locator, on_delete=models.CASCADE, related_name="locations_loc"
    )
